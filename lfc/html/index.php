...
<table id="themeExtra1" class=<?php if($_COOKIE['ctheme']=='away') {echo "'away'";} else {echo "'home'";} ?>>
<tr>
	...
	<td valign="top" width="30%" rowspan="5">
		<div style="float:right" id="expand-box-header">
			...
			<br>
			<table width="100%" id="themeLineup"  class=<?php if($_COOKIE['ctheme']=='away') {echo "'lineupA'";} else {echo "'lineupH'";} ?>>
				<?php
				...
				<div id="expand-box-header">
					<ul>
						<li style="float:left" id="themeHead5" class=<?php if($_COOKIE['ctheme']=='away') {echo "'awayHead'";} else {echo "'homeHead'";} ?>><a href="/lineup.php">Submit Lineup</a></li>
					</ul>
				</div>
				</td>
				</tr>
