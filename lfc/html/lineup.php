...
<?php
  ...
  if(!empty($_POST['add'])) {
	...
	foreach($_POST['add'] as $checka) {
	  ...
	  echo "<p>You can't add more than 11 players!</p>";
  }
  }
...
function AddToLineup($connection, $number, $position, $name){
	...
	if(!mysqli_query($connection, $addquery)) echo("<p>Error adding player data. Did you resubmit the form?</p>");
	if(!mysqli_query($connection, $delquery)) echo("<p>Error deleting player data. Did you resubmit the form?</p>");
}
...
<table id="themeExtra1" class=<?php if($_COOKIE['ctheme']=='away') {echo "'away'";} else {echo "'home'";} ?> width="100%">
<tr>
<td align="center">
<h1>Submit Lineup</h1>
</td>
...
<table border="3px" cellpadding="2" cellspacing="2" id="themeExtra2" class=<?php if($_COOKIE['ctheme']=='away') {echo "'away'";} else {echo "'home'";} ?>>
  <tr>
    <td><strong>Number</td>
...
<tr>
<td align="center">
<table border="3px" cellpadding="2" cellspacing="2" id="themeExtra3" class=<?php if($_COOKIE['ctheme']=='away') {echo "'away'";} else {echo "'home'";} ?>>
  <tr>
    <td><strong>Number</td>
    <td><strong>Position</td>
    <td><strong>Name</td>
