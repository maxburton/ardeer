        ...
        if (json.error) {
            ...
            for (var i = 0; i < json.items.length; i++) {
                ...
                if (this.cfg.layout == 'thumbnails') {
                    ...
                    //this.cfg.layout = full
                    li.innerHTML = '<table class="results" cellspacing="0" cellpadding="0" border="0"><tr><td valign="top" rowspan="2"></td><td valign="top"><h3>' + entry.snippet.title + '</h3><p><span>' + this.formatDescription(entry.snippet.description) + '</span></p></td><td valign="top" style="width: 150px" class="meta"><div>' + (entry.contentDetails ? '<p>Duration: ' + ytEmbed.formatDuration(entry.contentDetails.duration) + '<br>' : '') + (entry.statistics ? 'Views: ' + entry.statistics.viewCount + '<br>' : '') + 'From: <a href="http://www.youtube.com/profile?user=' + entry.snippet.channelTitle + '"></p>' + entry.snippet.channelTitle + '</a></div></td></tr></table>';
            ...
            if (this.cfg.paging == true && json.nextPageToken) {
                ...
                if (json.nextPageToken) {
                    ...
                    a.innerHTML = '<p class="load">Load next...</p>';
                ...
                if (json.prevPageToken) {
                    ...
                    a.innerHTML = '<p class="load">Load previous...</p>';
                    li.appendChild(a);
                    pul.appendChild(li);
                }
